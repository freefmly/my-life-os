...
function createDefaultInvestments() { return { soxl: { principal: 0, purchaseAmount: 0, cash: 0, shares: 0, averagePrice: 0, valuation: 0, subscriptionFeeKrw: 0, subscriptionFeeUsd: 0, includeFee: true, trades: [], snapshots: [] }, tqqqVr: { mode: 'installment', contribution: 0, withdrawal: 0, cycles: [] } }; }
